...
def generate_output(panel_name, config, output_dir="stl", image_dir="images", generate_png=True, multi_material=False):
    ...
    for part in parts:
        suffix = f"_{part}" if multi_material else ""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--multi", action="store_true", help="Export as separate body and diffuser parts")
